...
class QDropdownFieldWithHeader extends StatefulWidget {
  final String label;
  final String? hint;
  ...
  const QDropdownFieldWithHeader({
    Key? key,
    required this.label,
    required this.items,
  ...
  @override
  State<QDropdownFieldWithHeader> createState() =>
      _QDropdownFieldWithHeaderState();
}

class _QDropdownFieldWithHeaderState extends State<QDropdownFieldWithHeader> {
